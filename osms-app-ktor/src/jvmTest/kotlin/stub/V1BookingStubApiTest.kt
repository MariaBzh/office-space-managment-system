package ru.otus.osms.ktor.test.stub
...
class V1BookingStubApiTest {
    ...
    fun create() = v1TestApplication { client ->
        ...
        val response = client.post("api/v1/bookings/create") {
    ...
    fun read() = v1TestApplication { client ->
        ...
        val response = client.post("/api/v1/bookings/read") {
            contentType(ContentType.Application.Json)
            setBody(requestObj)
        }
    ...
    fun update() = v1TestApplication { client ->
        ...
        val response = client.post("/api/v1/bookings/update") {
            contentType(ContentType.Application.Json)
            setBody(requestObj)
        }
    ...
    fun delete() = v1TestApplication { client ->
        ...
        val response = client.post("/api/v1/bookings/delete") {
            contentType(ContentType.Application.Json)
            setBody(requestObj)
        }
    ...
    fun search() = v1TestApplication { client ->
        ...
        val response = client.post("/api/v1/bookings/search") {
            contentType(ContentType.Application.Json)
            setBody(requestObj)
        }
    ...
    fun badTime() = v1TestApplication { client ->
        val requestObj = BookingCreateRequest(
            ...
            booking = BookingCreateObject(
                ...
                workspaceUid = "workspace-1",
                startTime = "2025-01-01T10:00:00.0000",
                endTime = "2024-01-01T11:00:00.0000",
            ),
            debug = BookingDebug(
                mode = BookingRequestDebugMode.STUB,
